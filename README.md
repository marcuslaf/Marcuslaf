...
<table align="center" cellspacing="12" width="100%">
  <tr>
    <td width="33%" valign="top" style="background: #161b22; border: 1px solid #30363d; border-radius: 12px; padding: 20px 16px; text-align: center;">
      ...
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">Spring Security & JWT</div>
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">Docker & Containers</div>
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">React Query · TypeScript</div>
    </td>
    <td width="33%" valign="top" style="background: #161b22; border: 1px solid #30363d; border-radius: 12px; padding: 20px 16px; text-align: center;">
      <div style="font-size: 26px;">🚧</div>
      <div style="margin-top: 6px;"><b style="color: #e6edf3; font-size: 15px;">Construindo</b></div>
      <hr style="border: none; border-top: 1px solid #21262d; margin: 12px 0 16px 0;"/>
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">APIs RESTful com Java/Spring</div>
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">Dashboards React + TypeScript</div>
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">Projeto full stack completo</div>
    </td>
    <td width="33%" valign="top" style="background: #161b22; border: 1px solid #30363d; border-radius: 12px; padding: 20px 16px; text-align: center;">
      <div style="font-size: 26px;">🎯</div>
      <div style="margin-top: 6px;"><b style="color: #e6edf3; font-size: 15px;">Meta</b></div>
      <hr style="border: none; border-top: 1px solid #21262d; margin: 12px 0 16px 0;"/>
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">Arquitetura limpa</div>
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">Open Source</div>
      <div style="padding: 8px 0; color: #8b949e; font-size: 13px; white-space: nowrap;">Aplicações escaláveis</div>
    </td>
  </tr>
</table>
